"""
Django settings for sabina_chess project.
...
SECRET_KEY = os.environ.get('SECRET_KEY', 'django-insecure-zniktjdsx838+na^+bd8c=7i5#wfh+(n^y7@36lpaty$3v3#c4')
...
ROOT_URLCONF = 'sabina_chess.urls'
...
# In development (DEBUG=True)  → shows DEBUG and above for the chess app.
# In production (DEBUG=False)  → only WARNING and above reach the console.
LOGGING = {
    'version': 1,
    ...
    # Root logger: Django internals — only WARNING+ to avoid noise
    'root': {
        'handlers': ['console'],
        'level': 'WARNING',
    },
